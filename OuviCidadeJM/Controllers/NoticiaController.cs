    ...
    public class NoticiaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Noticias != null ? 
                          ...
                          Problem("Entity set 'WebAppContext.Noticias'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Proprietario,Detalhes,Resumo,DataCriacao,ID")] Noticia noticia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Proprietario,Detalhes,Resumo,DataCriacao,ID")] Noticia noticia)
        {
            if (id != noticia.ID)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'WebAppContext.Noticias'  is null.");
            }
            var noticia = await _context.Noticias.FindAsync(id);
            if (noticia != null)
            {
